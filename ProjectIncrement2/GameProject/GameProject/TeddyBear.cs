    ...
    public class TeddyBear
    {
        ...
        public void Update(GameTime gameTime)
        {
            ...
            if (elapsedShotMilliseconds > firingDelay)
            {
                ...
                int y = drawRectangle.Center.Y;

                // Adding projectille to the Game1
                Projectile projectile = new Projectile(projectileType, teddybearsprite, x, y, 
