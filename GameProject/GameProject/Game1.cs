...
namespace GameProject
{
    ...
    public class Game1 : Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            // Assigning burger field to Burger object
            burger = new Burger(Content, @"graphics/burger", 
                (GameConstants.WindowWidth / 2),
                (GameConstants.WindowHeight - (GameConstants.WindowHeight / 8 )),
                null
                );
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            // draw game objects
            // Uncommented burger draw method
        ...
        private void SpawnBear()
        {
            ...
            // create new bear
            TeddyBear newBear = new TeddyBear(Content, @"graphics/teddybear", x, y, 
                                velocity, null, null);
